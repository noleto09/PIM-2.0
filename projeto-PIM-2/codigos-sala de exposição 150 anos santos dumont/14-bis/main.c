...
int main(void){
    ...
    puts("Invenção: 14-BIS");
    puts("Inventor: Alberto Santos Dumont");
    puts("Descrição da Invenção: O ?14 BIS? tem capacidade para um tripulante. Foi o primeiro avião mais pesado que o ar a conseguir decolar por seus próprios meios. Esse fato histórico teve lugar em Bagatelle (centro de Paris), no dia 23 de outubro de 1906.");
    ...
    char perguntas[10][1000] = {
        ...
        "Em que ano o 14-Bis fez seu primeiro voo público bem-sucedido?",
