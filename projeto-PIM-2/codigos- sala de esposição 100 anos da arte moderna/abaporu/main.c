...
int main(void){
    ...
    char alternativas[5] [4] [100] ={
        ...
        {"a) Uma representação da cultura indigena brasileira","b) Uma expressção do nacionalismo artístico","c) Uma cr?tica social ou política","d) Outra"},
